...
instance Print (Latte.Abs.Arg' a) where
  prt i = \case
    Latte.Abs.ValArg _ type_ id_ -> prPrec i 0 (concatD [prt 0 type_, prt 0 id_])
    Latte.Abs.VarArg _ type_ id_ -> prPrec i 0 (concatD [prt 0 type_, doc (showString "&"), prt 0 id_])
...
instance Print (Latte.Abs.Decl' a) where
  prt i = \case
    Latte.Abs.Mutable _ type_ items -> prPrec i 0 (concatD [prt 0 type_, prt 0 items, doc (showString ";")])
    Latte.Abs.Immutable _ type_ items -> prPrec i 0 (concatD [doc (showString "const"), prt 0 type_, prt 0 items, doc (showString ";")])
...
instance Print (Latte.Abs.Stmt' a) where
  prt i = \case
    ...
    Latte.Abs.DStmt _ decl -> prPrec i 0 (concatD [prt 0 decl])
...
instance Print (Latte.Abs.Type' a) where
  prt i = \case
    ...
    Latte.Abs.Str _ -> prPrec i 0 (concatD [doc (showString "str")])
    Latte.Abs.Bool _ -> prPrec i 0 (concatD [doc (showString "bool")])
...
instance Print (Latte.Abs.Expr' a) where
  prt i = \case
    ...
    Latte.Abs.Not _ expr -> prPrec i 5 (concatD [doc (showString "not"), prt 6 expr])
    ...
    Latte.Abs.EAnd _ expr1 expr2 -> prPrec i 1 (concatD [prt 2 expr1, doc (showString "and"), prt 1 expr2])
    Latte.Abs.EOr _ expr1 expr2 -> prPrec i 0 (concatD [prt 1 expr1, doc (showString "or"), prt 0 expr2])
